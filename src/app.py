...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice drills, scrimmages, and seasonal matches",
        "schedule": "Wednesdays and Saturdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["noah@mergington.edu", "lucas@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Team practices and competitive games against other schools",
    ...
    "Debate Team": {
        "description": "Prepare for and compete in formal debate tournaments",
    ...
    "Robotics Club": {
        ...
        "max_participants": 12,
        "participants": ["liam@mergington.edu", "charlie@mergington.edu"]
    }
}
